...
# Valid genes 
GENES = ["Left", "Right", "Forward", "Backward"]

# Target string to be generated 
TARGET = ["Left", "Left", "Left", "Right", "Forward", "Right", "Forward", "Left", "Backward"]
...
class Individual(object): 
    ...
    def weighted_random_choice(cls, target_gene):
        ...
        for gene in GENES:
            ...
            weight = 1.0 / (1 + abs(GENES.index(gene) - GENES.index(target_gene)))
